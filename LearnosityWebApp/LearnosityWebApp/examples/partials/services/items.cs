...
namespace Learnosity {
    ...
    Dictionary<string, string> security = new Dictionary<string, string>();
    security.Add("consumer_key", "yis0TYCu7U9V4o7M");
    security.Add("domain", "demos.vg.learnosity.com");
    ...
    string[] request = new string[] {
        ...
        "user_id"        => "12345678",
        "items"          => new string[] {"Demo3", "Demo4", "Demo5", "Demo6", "Demo7", "Demo8", "Demo9", "Demo10"),
        "config"         => new string[] {
            "subtitle"   => "Walter White",
            Dictionary<string, string> navigation = new string[] {
                "show_intro"     => true,
                "show_itemcount" => true
            },
    ...
    string heading = "Items API";
    string description = "<p>Prepare your assessment configuration and items, we'll do the rest!</p>";
