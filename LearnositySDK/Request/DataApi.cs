...
namespace LearnositySDK.Request
{
    ...
    public class DataApi
    {
        ...
        public Remote request(string url, string securityPacketJson, string secret, string requestPacketJson = null, string action = null)
        {
            ...
            return this.handleRequest(url, new Init("data", securityPacketJson, secret, requestPacketJson, action, url));
        }
        ...
        {
            // Pass endpoint to Init for automatic metadata generation (consumer/action)
            return this.handleRequest(url, new Init("data", securityPacket, secret, requestPacket, action, url));
        }
